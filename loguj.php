...
//sprawdz czy uzutkownik ma potwierdzona aplikacje na facebooku oraz czy jest zalogowany
            if($me) {
                ...
                $zaloguj2 = mysql_fetch_array(mysql_query("SELECT login FROM konta WHERE fb_id='".$me['id']."' LIMIT 1")); 
...
<a href="zapomnialem.php">'.$lang['6'].'</a>';
    ...
    if($me = getUser($facebook)) {
        ...
        $zaloguj1 = mysql_fetch_array(mysql_query("SELECT login FROM konta WHERE fb_id='".$me['id']."' LIMIT 1")); 
